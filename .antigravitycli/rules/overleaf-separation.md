...
Creating a folder in the Overleaf root automatically creates an Overleaf project. This has implications for what Antigravity can and cannot do:

| Action | Antigravity allowed? | Notes |
|--------|:-:|-------|
