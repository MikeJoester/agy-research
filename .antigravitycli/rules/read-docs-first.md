...
1. `AGY.md` — already auto-loaded, but follow its pointers
...
1. **AGY.md and .context/ files** — they cover identity, projects, workflows, conventions
...
- Grepping for keywords when AGY.md explicitly lists where things are
...
1. Read that project's `AGY.md` (if it exists)
