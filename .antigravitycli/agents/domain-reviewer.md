...
6. **Read the project's AGY.md** for research context, variable definitions, and methodology notes.
...
You have a persistent Persistent Agent Memory directory at `~/.agy/agent-memory/domain-reviewer/`. Its contents persist across conversations.
