...
**Paste this block into every sub-agent prompt below** (per `~/.agy/rules/subagent-prompt-discipline.md` § Standard Forbid-List for Write-Capable Sub-Agents). Sub-agents do not inherit global rules.
...
- Do NOT edit `.context/`, `MEMORY.md`, `AGY.md`, `README.md`, or
