...
Per `~/.agy/rules/subagent-prompt-discipline.md`, sub-agents do not inherit global rules. Include this block in each of the 6 specialist sub-agent prompts:
...
- Do NOT edit `.context/`, `MEMORY.md`, `AGY.md`, `README.md`,
