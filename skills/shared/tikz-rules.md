...
When labelling curved arrows using `connectionstyle='arc3,rad=R'`, compute the actual curve position before placing labels. The same "Antigravity cannot eyeball where a curve passes" rule from Pass 1 applies to Python figures.
